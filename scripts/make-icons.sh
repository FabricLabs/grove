...
if [ -x "$(command -v iconutil)" ]; then
  # available on macos
  iconutil -c icns -o res/build/icon.icns "$tmpdir/Riot.iconset"
  ...
  png2icns res/build/icon.icns "$tmpdir"/Riot.iconset/*png
else
  echo "WARNING: Unsupported platform. Skipping icns build"
fi

cp "$tmpdir/36.png" "res/vector-icons/android-chrome-36.png"
cp "$tmpdir/48.png" "res/vector-icons/android-chrome-48.png"
cp "$tmpdir/72.png" "res/vector-icons/android-chrome-72.png"
cp "$tmpdir/96.png" "res/vector-icons/android-chrome-96.png"
cp "$tmpdir/144.png" "res/vector-icons/android-chrome-144.png"
cp "$tmpdir/192.png" "res/vector-icons/android-chrome-192.png"
...
cp "$tmpdir/16.png" "res/vector-icons/favicon-16.png"
cp "$tmpdir/32.png" "res/vector-icons/favicon-32.png"
cp "$tmpdir/96.png" "res/vector-icons/favicon-96.png"
...
cp "$tmpdir/180.png" "res/img/riot.png"
cp "$tmpdir/180.png" "../desktop/res/img/element.png"

convert "$tmpdir/16.png" "$tmpdir/32.png" "$tmpdir/64.png" "$tmpdir/128.png"  "$tmpdir/256.png" "res/vector-icons/favicon.ico"

cp "res/vector-icons/favicon.ico" "res/build/icon.ico"
cp "res/vector-icons/favicon.ico" "res/img/element.ico"
cp "res/vector-icons/favicon.ico" "../desktop/res/img/element.ico"
cp "res/build/icon.icns" "../desktop/build/icon.icns"
cp "res/build/icon.ico" "../desktop/build/icon.ico"
...
do
    cp "$tmpdir/$i.png" "res/build/icons/${i}x${i}.png"
    cp "$tmpdir/$i.png" "../desktop/build/icons/${i}x${i}.png"
done
