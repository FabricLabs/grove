...
cp "$tmpdir/32.png" "$tmpdir/RPG.iconset/icon_16x16@2x.png"
cp "$tmpdir/32.png" "$tmpdir/RPG.iconset/icon_32x32.png"
cp "$tmpdir/64.png" "$tmpdir/RPG.iconset/icon_32x32@2x.png"
cp "$tmpdir/128.png" "$tmpdir/RPG.iconset/icon_128x128.png"
cp "$tmpdir/256.png" "$tmpdir/RPG.iconset/icon_128x128@2x.png"
cp "$tmpdir/256.png" "$tmpdir/RPG.iconset/icon_256x256.png"
cp "$tmpdir/512.png" "$tmpdir/RPG.iconset/icon_256x256@2x.png"
cp "$tmpdir/512.png" "$tmpdir/RPG.iconset/icon_512x512.png"
cp "$tmpdir/1024.png" "$tmpdir/RPG.iconset/icon_512x512@2x.png"

if [ -x "$(command -v iconutil)" ]; then
  # available on macos
  iconutil -c icns -o electron_app/build/icon.icns "$tmpdir/RPG.iconset"
  ...
  rm "$tmpdir/RPG.iconset/icon_128x128@2x.png"
  rm "$tmpdir/RPG.iconset/icon_256x256@2x.png"
  rm "$tmpdir/RPG.iconset/icon_16x16@2x.png"
  rm "$tmpdir/RPG.iconset/icon_32x32@2x.png"
  png2icns electron_app/build/icon.icns "$tmpdir"/RPG.iconset/*png
else
  echo "WARNING: Unsupported platform. Skipping icns build"
fi

cp "$tmpdir/36.png" "res/rpg-icons/android-chrome-36x36.png"
cp "$tmpdir/48.png" "res/rpg-icons/android-chrome-48x48.png"
cp "$tmpdir/72.png" "res/rpg-icons/android-chrome-72x72.png"
cp "$tmpdir/96.png" "res/rpg-icons/android-chrome-96x96.png"
cp "$tmpdir/144.png" "res/rpg-icons/android-chrome-144x144.png"
cp "$tmpdir/192.png" "res/rpg-icons/android-chrome-192x192.png"
cp "$tmpdir/180.png" "res/rpg-icons/apple-touch-icon.png"
cp "$tmpdir/180.png" "res/rpg-icons/apple-touch-icon-precomposed.png"
cp "$tmpdir/57.png" "res/rpg-icons/apple-touch-icon-57x57.png"
cp "$tmpdir/60.png" "res/rpg-icons/apple-touch-icon-60x60.png"
cp "$tmpdir/72.png" "res/rpg-icons/apple-touch-icon-72x72.png"
cp "$tmpdir/76.png" "res/rpg-icons/apple-touch-icon-76x76.png"
cp "$tmpdir/114.png" "res/rpg-icons/apple-touch-icon-114x114.png"
cp "$tmpdir/120.png" "res/rpg-icons/apple-touch-icon-120x120.png"
cp "$tmpdir/144.png" "res/rpg-icons/apple-touch-icon-144x144.png"
cp "$tmpdir/152.png" "res/rpg-icons/apple-touch-icon-152x152.png"
cp "$tmpdir/180.png" "res/rpg-icons/apple-touch-icon-180x180.png"
cp "$tmpdir/16.png" "res/rpg-icons/favicon-16x16.png"
cp "$tmpdir/32.png" "res/rpg-icons/favicon-32x32.png"
cp "$tmpdir/96.png" "res/rpg-icons/favicon-96x96.png"
cp "$tmpdir/70.png" "res/rpg-icons/mstile-70x70.png"
cp "$tmpdir/144.png" "res/rpg-icons/mstile-144x144.png"
cp "$tmpdir/150.png" "res/rpg-icons/mstile-150x150.png"
cp "$tmpdir/310.png" "res/rpg-icons/mstile-310x310.png"
cp "$tmpdir/310x150.png" "res/rpg-icons/mstile-310x150.png"
cp "$tmpdir/180.png" "electron_app/img/riot.png"

convert "$tmpdir/16.png" "$tmpdir/32.png" "$tmpdir/64.png" "$tmpdir/128.png"  "$tmpdir/256.png" "res/rpg-icons/favicon.ico"

cp "res/rpg-icons/favicon.ico" "electron_app/build/icon.ico"
cp "res/rpg-icons/favicon.ico" "electron_app/img/riot.ico"
